...
const workOnForm = () => {
    ...
    checkValidName(fullName, nameNode[1], nameNode[2], nameNode[3]);
    ...
    //const tech = regForm.elements['techKnown'].value;
    //const experience = regForm.elements['experience'].value;
...
populateTable();
/*
    dont show error message but show msg under input field.
*/
const deleteUser = id => {
