...
const createTechArray = (techObj) => {
    const keys = Object.keys(techObj);
    const value = Object.values(techObj);
    keys.forEach((key, index)=> {
// find: if put console.log(key + "=" + value[index]) it will print object, why??
        console.log(key +  " = ");
